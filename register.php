...
<?php 
  ...
  if(isset($_POST['firstname'])&&isset($_POST['lastname'])&&isset($_POST['email'])&&isset($_POST['password'])){
    ...
    $sql = "insert into 31301105_user (firstname,lastname,email,password) value ('".$firstname."','".$lastname."','".$email."','".$password."')";
	...
	<div class="login-page">
		...
		<div class="widget-shadow">
			...
			<div class="login-body">
				<form class="wow fadeInUp animated" action="register.php" method="post" data-wow-delay=".7s">
