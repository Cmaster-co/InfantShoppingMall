				...
				<div class="nav navbar-nav wow fadeInLeft animated" data-wow-delay=".5s">
					<?php 
						if(!isset($_SESSION['useremail'])){
							...
							echo "<p>Welcome to Modern Shoppe ".$_SESSION['useremail']."</p>";
						}
					 ?>
				</div>
		...
		<div class="container">
			<div class="col-md-9 product-model-sec">
				...
				<div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".5s">
					<div class="new-top">
						<a href="single.html"><img src="images/<?php echo $products[$i]['img']; ?>" class="img-responsive" alt=""/></a>
						<div class="new-text">
							<ul>
								<li><a href="single.html">Quick View </a></li>
								<li><input type="number" class="item_quantity" min="1" value="1"></li>
								<li><a class="item_add" href="addCart.php?id=<?php echo $products[$i]['Id']; ?>" > Add to cart</a></li>
							</ul>
						</div>
					</div>
					<div class="new-bottom">
						<h5><a class="name" href="single.html"><?php echo $products[$i]['name'] ?></a></h5>
						<div class="rating">
							<span class="on">☆</span>
							<span class="on">☆</span>
							<span class="on">☆</span>
						...
						<div class="ofr">
							<p class="pric1"><del><?php echo $products[$i]['oldprice'] ?></del></p>
							<p><span class="item_price"><?php echo $products[$i]['newprice'] ?></span></p>
						</div>
					</div>
				</div>
				<?php } ?>
