...
<?php 
	include 'config.php';
  	if(isset($_POST['email'])&&isset($_POST['password'])){
  		if ($_POST['checkcode']!==$_SESSION['authcode']) {
	    ...
	    $sql = "select * from 31301105_user where email = '".$email."' and password = '".$password."'";
...
?>
		...
		<div class="widget-shadow">
			...
			<div class="login-body wow fadeInUp animated" data-wow-delay=".7s">
				<form action="signin.php" method="post">
					...
					<input type="text" name="checkcode" class="lock" placeholder="checkcode"><img id="checkpic" onclick="changing();" src="showimg.php"/>
	...
	<script type="text/javascript">
  		function changing(){
    		document.getElementById('checkpic').src="showimg.php?"+Math.random();
		} 
	</script>
	<!--search jQuery-->
