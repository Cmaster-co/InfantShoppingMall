	...
	<div class="cart-items">
		<div class="container">
			<?php 
				...
				$len = count($array)-1;
			?>
			<h3 class="wow fadeInUp animated" data-wow-delay=".5s">My Shopping Cart(<?php echo $len; ?>)</h3>
			<?php 
				$array = explode("@", $_SESSION['productlist']);
				for ($i=0; $i < count($array)-1; $i++) { 
					...
					if ($id != "") {
						...
						$info = mysqli_fetch_array($sql,MYSQLI_BOTH);
						?>
						<div class="cart-header wow fadeInUp animated" data-wow-delay=".5s">
							<div class="alert-close"> </div>
							<div class="cart-sec simpleCart_shelfItem">
								<div class="cart-item cyc">
									<a href="single.html"><img src="images/<?php echo $info['img']; ?>" class="img-responsive" alt=""></a>
								</div>
